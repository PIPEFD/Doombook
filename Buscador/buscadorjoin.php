...
$consulta="SELECT usuario.Nombre_usuario, usuario.Apellido, usuario.Alias, tipo_usuario.Descripcion_Usuario FROM usuario 
INNER JOIN tipo_usuario ON usuario.Cod_tipo_usuario = tipo_usuario.Cod_tipo_usuario 
WHERE tipo_usuario.Descripcion_Usuario LIKE '%$busqueda%'";

$resultado=mysqli_query($conexion, $consulta);

echo "<table class='table table-hover table-bordered border-primary'>";
echo "<tr><th>Rol</th><th>Nombre</th><th>Apellido</th><th>Alias</th></tr>";
...
while($fila=mysqli_fetch_row($resultado)) {
    ...
    echo "<tr><td>".ucfirst($fila[3])."</td><td>$fila[0]</td><td>$fila[1]</td><td>$fila[2]</td></tr>";
